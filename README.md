...
- **Add tasks** - type in the input at the top and click *Add task* or press Ctrl+Enter
- **Edit tasks** - hover a card and click the pencil icon to edit inline; Ctrl+Enter or click away to save, Esc to cancel
